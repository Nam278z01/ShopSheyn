app.controller('ProductController', function ($scope, $rootScope, $http, $routeParams, $location, API_URL) {
    $scope.filter = {
    ...
    $scope.changeSubCategories = function (subcategory) {
        if (subcategory.checked) {
            let arr = JSON.parse($scope.filter.list_subcategory_id).filter((subcategory_id) => {
