<header class="h-[54px]">
			<div class="fixed left-0 w-full z-50">
				<!-- Navigation -->
				<nav
					class="relative flex items-center h-[54px] w-full px-5 shadow-[0_6px_12px_0_#0000000a] bg-[#fff] border-b border-transparent hover:bg-[#f9f86c]">
					...
					<div class="flex h-[54px] items-center w-3/4">
						...
						<div class="group pointer-events-none">
							<a href="#!/product"
								...
								<div class="h-[54px] text-[#8e8e8e]">Trang Phục</div>
							</a>
									...
									<div class="px-[15px] text-[13px] w-[400px]">
										...
										<ul class="mt-5 flex flex-col flex-wrap h-[300px]">
											<li class="leading-7 capitalize w-2/4">
												<a href="#" class="text-black font-bold hover:text-[#fa6338]">Tất cả</a>
											</li>
											<li ng-repeat="c in categories" class="leading-7 capitalize w-2/4">
												<a href="#" class="text-black font-bold hover:text-[#fa6338]">@{{ c.category_name }}</a>
											</li>
										</ul>
									</div>
									<div class="px-[15px] text-[13px] w-[200px]">
										...
										<ul class="mt-5">
											<li class="leading-7 capitalize">
												<a href="#" class="text-black font-bold hover:text-[#fa6338]">Hàng mới nhất</a>
											</li>
											<li class="leading-7 capitalize">
												<a href="#" class="text-black font-bold hover:text-[#fa6338]">Bán chạy nhất</a>
											</li>
											<li class="leading-7 capitalize">
												<a href="#" class="text-black font-bold hover:text-[#fa6338]">Giảm giá nhiều nhất</a>
											</li>
										</ul>
									</div>
								</div>
